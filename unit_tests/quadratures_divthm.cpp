...
test_divergence_theorem(const Mesh& msh)
{
    ...
    std::cout << "Global area: " << totarea << ", global error: " << toterr << std::endl;
...
test_divergence_theorem(const Mesh& msh)
{
    ...
    std::cout << "Global volume: " << totvol << ", global error: " << toterr << std::endl;
...
{
    std::cout << "Simplicial 2D internal mesher" << std::endl;
    using T = double;
...
bool test_cartesian_2D(void)
{
    std::cout << "Cartesian 2D internal mesher" << std::endl;
    using T = double;
...
{
    std::cout << "Generic 2D internal mesher" << std::endl;
    using T = double;
...
bool test_fvca5(const std::string& filename)
{
    using T = double;
    std::cout << "FVCA5 " + filename << std::endl;
    disk::generic_mesh<T,2> msh;
...
int main(void)
{
    ...
    std::cout << "Test data directory: " << DISKPP_SOURCE_DIR << std::endl;

    std::string tdpath = DISKPP_SOURCE_DIR;
    tdpath += "/unit_tests/test_data";

    success &= test_simplicial_2D();
    success &= test_cartesian_2D();
    success &= test_generic_2D();
    success &= test_simplicial_3D();
    success &= test_fvca5(tdpath + "/hex.typ1");
    success &= test_fvca5(tdpath + "/kershaw.typ1");
    success &= test_fvca6(tdpath + "/tet.1.msh");
    //success &= test_fvca6(tdpath + "/dbls_10.msh");
    success &= test_fvca6(tdpath + "/dbls_20.msh");

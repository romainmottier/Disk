...
void ERK4_MLTS_CenterSquareCoarse_PellSparse_conv_test(int argc, char **argv);
...
void ERK4_MLTS_CenterSquareCoarse_PellSparse_conv_test(int argc, char **argv)
{
    ...
    conv_fname << out_dir << "/centersquarecoarse_pellsparse_mlts_convergence_k_" << mesh_k << ".txt";
    ...
    for (int N : level_N) {
        ...
        mesh_fname << mesh_dir << "centersquarecoarse_graded_k" << mesh_k << "_N" << N << ".txt";

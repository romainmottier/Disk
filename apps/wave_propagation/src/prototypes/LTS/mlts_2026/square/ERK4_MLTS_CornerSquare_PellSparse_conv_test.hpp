...
void ERK4_MLTS_CornerSquare_PellSparse_conv_test(int argc, char **argv);
...
void ERK4_MLTS_CornerSquare_PellSparse_conv_test(int argc, char **argv)
{
    ...
    const std::string mesh_dir = "/home/mottie0000/Github/Diskpp/Disk/apps/wave_propagation/src/mesh_generation/corner_square_graded/meshes/";
    ...
    conv_fname << out_dir << "/cornersquare_pellsparse_mlts_convergence_k_" << mesh_k << ".txt";
    ...
    for (int N : level_N) {
        ...
        mesh_fname << mesh_dir << "cornersquare_graded_k" << mesh_k << "_N" << N << ".txt";
